...
*
     * @throws \HapiRepository\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HapiRepository\Model\Profile, HTTP status code, HTTP response headers (array of strings)
     */
...
*
     ...
     * @return object
     */
    public function getProfiles($body)
    {
        list($response) = $this->getProfilesWithHttpInfo($body);
        return $response;
    }
...
*
     ...
     */
    public function getProfilesWithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->getProfilesRequest($body);
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProfilesAsync($body)
    {
        return $this->getProfilesAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProfilesAsyncWithHttpInfo($body)
    {
        $returnType = 'object';
        $request = $this->getProfilesRequest($body);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getProfilesRequest($body)
    {
// verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling getProfiles'
            );
        }
